        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfReports = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationOfHazard = table.Column<string>(nullable: true),
                    DateOfSpottedHazard = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Investigation_AspNetUsers_InvestigatorId",
                        column: x => x.InvestigatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Investigation_Report_ReportId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Investigation_ReportId1",
                table: "Investigation",
                column: "ReportId1");
